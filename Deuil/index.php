...
<html lang="fr">
    <head>
        ...
        <title>Au Grain de Pollen - Deuil - Fleuriste Les Grandes-Ventes</title>
        <meta name="description" content="Composition floral réaliser par le magazin Au Grain de Pollen dans le cadre de deuils.">
    </head>
    <body>
        <?php 
            include "../menu.php"; 
