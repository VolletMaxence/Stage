...
<html lang="en">
    ...
    <body>
        ...
        <!-- Image simple -->
        <div class=image3>
            <img class="image_presentation" src="../../Image/test/test2.png" alt="Image page d'acceuil">
        </div> 
        <!-- Image simple -->
        <div class=image4>
            <img class="image_presentation" src="../../Image/test/test2.png" alt="Image page d'acceuil">
        ...
        <!-- Image simple -->
        <div class=image5>
            <img class="image_presentation" src="../../Image/test/test3.png" alt="Image page d'acceuil">
        </div> 
        <!-- Image simple -->
        <div class=image6>
            <img class="image_presentation" src="../../Image/test/test3.png" alt="Image page d'acceuil">
